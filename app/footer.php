...
<div class="footer py-4 d-flex flex-lg-column " id="kt_footer">
    ...
    <div class=" container-xxl  d-flex flex-column flex-md-row flex-stack">
        ...
        <div class="text-gray-900 order-2 order-md-1">
            <span class="text-gray-500 fw-semibold me-1">Criado by</span>
            <a href="https://ibanco.me" target="_blank" class="text-muted text-hover-primary fw-semibold me-2 fs-6">SJ Capital</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
        <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
            <li class="menu-item"><a href="https://ibanco.me" target="_blank" class="menu-link px-2">Sobre</a></li>
            <li class="menu-item"><a href="https://devs.ibanco.me" target="_blank" class="menu-link px-2">Suporte</a></li>
        </ul>
        <!--end::Menu-->
    </div>
    <!--end::Container-->
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="/metronic8/demo7/../demo7/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/doc-1.svg">
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="/metronic8/demo7/../demo7/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/css-1.svg">
                                        <!--end::Icon-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="assets/media/stock/600x400/img-29-1.jpg">
                                        </div>
                                        <!--end::Image-->
                                    ...
                                    <div class="overlay me-10">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="assets/media/stock/600x400/img-31-1.jpg">
                                        </div>
                                        <!--end::Image-->
                                    ...
                                    <div class="overlay">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="assets/media/stock/600x400/img-40-1.jpg">
                                        </div>
                                        <!--end::Image-->
                ...
                <div class="d-flex justify-content-start mb-10 ">
                    ...
                    <div class="d-flex flex-column align-items-start">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <!--begin::Avatar-->
                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="assets/media/avatars/300-25-1.jpg"></div><!--end::Avatar-->
                            <!--begin::Details-->
                            <div class="ms-3">
                ...
                <div class="d-flex justify-content-end mb-10 ">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <!--begin::Avatar-->
                            <div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="assets/media/avatars/300-1-1.jpg"></div><!--end::Avatar-->
                        </div>
                        <!--end::User-->
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <label class="d-flex flex-stack cursor-pointer mb-5">
                                            ...
                                            <span class="d-flex align-items-center me-2">
                                                ...
                                                <span class="symbol symbol-50px me-6">
                                                    <span class="symbol-label bg-light-danger">
                                                        <i class="ki-duotone ki-angular fs-2x text-danger"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
                                                    </span>
                                                </span>
                                                <!--end:Icon-->
                                        ...
                                        <label class="d-flex flex-stack cursor-pointer">
                                            ...
                                            <span class="d-flex align-items-center me-2">
                                                ...
                                                <span class="symbol symbol-50px me-6">
                                                    <span class="symbol-label bg-light-primary">
                                                        <i class="ki-duotone ki-vue fs-2x text-primary"><span class="path1"></span><span class="path2"></span></i>
                                                    </span>
                                                </span>
                                                <!--end:Icon-->
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="assets/media/svg/card-logos/visa-1.svg" alt="" class="h-25px">
                                                <img src="assets/media/svg/card-logos/mastercard-1.svg" alt="" class="h-25px">
                                                <img src="assets/media/svg/card-logos/american-express-1.svg" alt="" class="h-25px">
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                                        <!--end::Input wrapper-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="assets/media/illustrations/sigma-1/9-1.png" alt="" class="mw-100 mh-300px">
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="assets/media/illustrations/sigma-1/1-1.png" alt="" class="w-100 h-200px h-sm-325px">
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Empty-->
